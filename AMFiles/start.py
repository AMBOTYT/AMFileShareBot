...
from AMFiles.helper_func import subscribed, encode, decode, get_messages
from AMFiles.database.sql import add_user, query_msg, full_userbase
...
START_MSG = """
ʜᴇʟʟᴏ {first}\n
๏ ɪ ᴀᴍ ꜰɪʟᴇꜱ ꜱʜᴀʀᴇ ʙᴏᴛ ᴀɴᴅ ɪ ʜᴀᴠᴇ sᴘᴇᴄɪᴀʟ ғᴇᴀᴛᴜʀᴇs
...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🍒 ᴜᴘᴅᴀᴛᴇs", url = "https://t.me/AMBOTYT"),
                    InlineKeyboardButton("🔐 ᴀʙᴏᴜᴛ", callback_data = "about"),
                    InlineKeyboardButton("🍻 sᴜᴘᴘᴏʀᴛ", url = "https://t.me/AM_YTSUPPORT")
                ],
                [                    
...
@Bot.on_message(filters.private & filters.command('gcast') & filters.user(OWNER_ID))
