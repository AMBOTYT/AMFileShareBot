...
from AMFiles.stats import get_shortlink
from config import OWNER_ID, CHANNEL_ID, DISABLE_CHANNEL_BUTTON
from AMFiles.helper_func import encode


@Bot.on_message(filters.private & filters.user(OWNER_ID) & ~filters.command(['start','stats','gcast','batch','genlink']))
